...
class DummyScraper(BaseScraper):
    ...
    async def get_earning_amount(self, page): ...
    async def get_employer_name(self, page): ...
    async def get_job_requirement(self, page): ...
    async def get_position_name(self, page): ...
